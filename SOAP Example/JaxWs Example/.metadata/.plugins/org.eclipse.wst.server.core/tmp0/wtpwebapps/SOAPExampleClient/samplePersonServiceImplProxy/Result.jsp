...
<BODY>
	...
	<jsp:useBean id="samplePersonServiceImplProxyid" scope="session"
		class="com.soap.jaxws.service.PersonServiceImplProxy" />
	<%
	...
	%>
	<jsp:useBean id="com1soap1jaxws1beans1Person_1id" scope="session"
		class="com.soap.jaxws.beans.Person" />
	<%
